...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      -- LspAttach autocmd runs when an LSP attaches to a particular buffer.
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Godot pipe server for gdscript
          if client and client.name == 'gdscript' then
            vim.api.nvim_command 'echo serverstart("/tmp/godot.pipe")'
          end

          -- Highlight references of word under cursor when cursor rests there (see :help CursorHold)
      ...
      -- Configure LSP capabilities with blink.cmp completion
      local capabilities = require('blink.cmp').get_lsp_capabilities()

      -- Global LSP configuration applied to all servers (Neovim 0.11+)
      vim.lsp.config('*', {
      ...
      -- Mason setup for auto-installing tools
      require('mason').setup()
      ...
      -- mason-lspconfig v2+ uses automatic_enable to enable installed servers
      require('mason-lspconfig').setup {
        ensure_installed = { 'lua_ls', 'eslint', 'tailwindcss', 'ts_ls', 'graphql' },
        automatic_enable = true,
      }

      -- Enable non-Mason LSPs manually
